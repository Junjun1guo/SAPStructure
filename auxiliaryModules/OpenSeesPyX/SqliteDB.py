...
class SqliteDB(object):
    ...
    def saveNodes(self,nodesSaveName,nodeList):
        ...
        insertNodes = f"""
                        ...
                        values (:tags,:contents) """  # values中的tags等为实参,nodes中为形参
    ...
    def saveNodeTimeHistory(self,nodeSaveName,nodeHistoryList):
        ...
        insertNodes = f"""
                        ...
                        values (:times,:dof_1,:dof_2,:dof_3) """  # values中的tags等为实参,nodes中为形参
    ...
    def saveTrussEleResponseTimeHistory(self,eleSaveName,eleHistoryList):
        ...
        insertNodes = f"""
                                ...
                                values (:times,:resValue) """  # values中的tags等为实参,nodes中为形参
    ...
    def saveZeroEleResponseTimeHistory(self,eleSaveName,eleHistoryList):
        ...
        insertNodes = f"""
                    ...
                    values ({realLinkStr}) """  # values中的tags等为实参,nodes中为形参
        self.db.bulk_query(insertNodes, eleResponseDict)
        db = records.Database('sqlite:///' + self._dbPath)  # connect to the sqlite database
        db.close()
    ...
    def saveNonEleSectResponseTimeHistory(self,eleSaveName,eleHistoryList):
        ...
        insertNodes = f"""
                        ...
                        values (:times,:dof_1,:dof_2,:dof_3,:dof_4) """  # values中的tags等为实参,nodes中为形参
        self.db.bulk_query(insertNodes, eleResponseDict)
        db = records.Database('sqlite:///' + self._dbPath)  # connect to the sqlite database
        db.close()
    ...
    def saveNonZeroEleResponseTimeHistory(self,eleSaveName,eleHistoryList):
        ...
        insertNodes = f"""
                                ...
                                :dofJ_1,:dofJ_2,:dofJ_3,:dofJ_4,:dofJ_5,:dofJ_6) """  # values中的tags等为实参,nodes中为形参
        self.db.bulk_query(insertNodes, eleResponseDict)
        db = records.Database('sqlite:///' + self._dbPath)  # connect to the sqlite database
        db.close()
